...
open class CheckBox: UIControl {
    ...
    @IBInspectable
    var checkedBorderColor: UIColor = UIColor(red: 17/255, green: 182/255, blue: 28/255, alpha: 1)
    
    @IBInspectable
    var checkmarkColor: UIColor = UIColor(red: 17/255, green: 182/255, blue: 28/255, alpha: 1)
    
    @IBInspectable
    var checkboxBackgroundColor: UIColor! = UIColor(red: 17/255, green: 182/255, blue: 28/255, alpha: 1)
